      ...
      <div class="container mx-auto px-4 md:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div class="lg:col-span-7" data-aos="fade-right">
            ...
            >
              <div
                class="aspect-video w-full rounded-xl overflow-hidden shadow-2xl relative"
              >
                <video
                ...
                >
                  <source
                    src="assets/images/1779074035189_7983307016412442049_g2758941255649715778.mp4"
                    type="video/mp4"
                  />
          ...
          <div class="lg:col-span-5 flex flex-col gap-6" data-aos="fade-left">
            <div class="flex items-start gap-4">
              <div
                class="w-10 h-10 rounded-full bg-gold/10 border border-gold/30 flex items-center justify-center text-gold text-lg shrink-0"
              >
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                <h4
                  class="text-xs font-bold uppercase tracking-wide text-white mb-1"
                >
                  Thiết kế hộp và chai sang trọng
                </h4>
                <p class="text-xs text-gray-300 font-light">
                  Đóng gói chuẩn chỉnh, bọc chống sốc cẩn thận, chai thủy tinh
                  dày dặn, nắp xi mạ vàng tinh xảo, thích hợp làm quà tặng.
                </p>
              </div>
            </div>
          </div>
