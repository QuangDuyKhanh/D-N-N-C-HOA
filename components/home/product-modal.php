    ...
    <div id="detail-modal" class="detail-modal">
      ...
      <div class="detail-modal-container p-6 md:p-10">
        ...
        <div class="mt-12 pt-8 border-t border-white/10">
          <h3 class="font-title text-xl font-bold text-white mb-6">Product Reviews</h3>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4 bg-white/5 border border-white/5 rounded-xl p-6 flex flex-col items-center justify-center text-center">
              ...
              <span id="reviews-total-count" class="text-xs text-gray-400">0 reviews</span>
            ...
            <div class="lg:col-span-8 flex flex-col gap-6">
              ...
              <div class="bg-white/5 border border-white/5 rounded-xl p-5 mt-2">
                <h4 class="text-xs font-bold uppercase tracking-wide text-white mb-4">Write Your Review</h4>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label class="text-[10px] uppercase tracking-wide text-gray-400 font-semibold mb-1 block">Your Name *</label>
                    <input type="text" id="review-user-name" required placeholder="Enter your name..." class="w-full bg-white/5 border border-white/10 rounded px-3 py-2 text-xs text-white" />
                  </div>
                  <div>
                ...
                <div class="mb-4">
                  <label class="text-[10px] uppercase tracking-wide text-gray-400 font-semibold mb-1 block">Review Content *</label>
                  <textarea id="review-content" required rows="3" placeholder="Share your experience about scent, longevity, packaging..." class="w-full bg-white/5 border border-white/10 rounded px-3 py-2 text-xs text-white resize-none"></textarea>
                </div>
